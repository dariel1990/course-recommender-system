        ...
        <div class="row m-0">
            <div class="col-12 p-0">
                <div class="login-card">
                    <div>
                        <div><a class="logo" href="#"><img class="img-fluid for-light" width="180px"
                        ...
                        <div class="login-main">
                            ...
                            @endif
                            <form class="theme-form" method="POST" action="{{ route('examination.auth') }}">
                                @csrf
                                <p class="text-center">Enter your Reference Code to access the Examination Page</p>
                                <div class="form-group">
                                    <label class="col-form-label">Reference Code</label>
                                    <input class="form-control @error('referenceCode') is-invalid @enderror"
                                        type="text" required name="referenceCode" placeholder="Enter Reference Code"
                                        value="{{ old('referenceCode') }}">
                                    @error('referenceCode')
                                ...
                                <div class="form-group mb-0">
                                    <div class="text-end mt-3">
                                        <button class="btn btn-primary btn-block w-100" type="submit">Submit
                                        </button>
                                        <a href="/" class="btn btn-danger btn-block w-100 mt-2">Go back
                                            to Main page
                                        </a>
                                    </div>
                                </div>
