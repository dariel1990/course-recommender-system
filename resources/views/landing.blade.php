            ...
            <div class="col-12 p-0">
                <div class="login-card">
                    <div>
                        ...
                        <div class="login-main d-grid">
                            <a class="btn btn-success btn-block text-uppercase"
                                href="{{ route('examination.login') }}">Take the
                                Exam</a>
                            <a class="btn btn-primary btn-block mt-2" href="{{ route('examinations') }}">Go to Admin
                                Page</a>
                        </div>
                    </div>
                </div>
