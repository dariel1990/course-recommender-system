                ...
                <div class="card">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                ...
                                <div class="setting-list">
                                    <a class="btn btn-xs btn-link text-danger" href="/users"><i
                    ...
                    <div class="card-body row ">
                        <div class="col-sm-12 col-lg-12 col-xl-12">
                            ...
                            <div class="mb-2 m-form__group">
                                <div class="input-group"><span class="input-group-text" style="width:140px">Email
                                        Address</span>
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary btn-block w-100 mt-3 text-uppercase" type="submit">Create
                                    User</button>
                            </div>
                            {!! Form::close() !!}
                        </div>
